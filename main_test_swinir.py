...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='./superresolution/agileir_sr_lightweight_x4/models/115200_G.pth')
    # parser.add_argument('--folder_lq', type=str, default="testsets/Set14/LR_bicubic/X4", help='input low-quality test image folder')
    # parser.add_argument('--folder_gt', type=str, default="testsets/Set14/HR", help='input ground-truth test image folder')

    # parser.add_argument('--folder_lq', type=str, default="testsets/image_SRF_4/LR", help='input low-quality test image folder')
    # parser.add_argument('--folder_gt', type=str, default="testsets/image_SRF_4/HR", help='input ground-truth test image folder')
    ...
    model = agileir(upscale=4, img_size=64,
                   window_size=16, img_range=1., depths=[6, 8, 6],
                   embed_dim=96, num_heads=[12,12,12], key_dims=[32,32,32], mlp_ratio=2, upsampler='pixelshuffledirect')
